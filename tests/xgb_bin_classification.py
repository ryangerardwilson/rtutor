...
class AUCMaximizer:
    ...
    def manual_without_rfe(self):
        X_train, X_test, y_train, y_test = train_test_split(
            ...
            self.tabular_data_df.converted,
            test_size=self.test_size,
            random_state=self.random_state,
            stratify=self.tabular_data_df.converted
        )
    ...
    def automated_without_rfe(self):
        X_train_full, X_test, y_train_full, y_test = train_test_split(
            self.tabular_data_df.drop('converted', axis=1),
            self.tabular_data_df['converted'],
            test_size=self.test_size,
            random_state=self.random_state,
            stratify=self.tabular_data_df['converted']
...
# Example usage
maximizer = AUCMaximizer(tabular_data_df, features)
